...
public class ConfigurationService {
    ...
    private static final String DEFAULT_CONFIG = """
            ...
            #   http://<server_url>:<server_port>/proxy/id/%1$s
            
            # 2. В данном режиме будет происходить запуск на случайной свободной ноде, у которой есть указанный при запуске тег.
            ...
            #   http://<server_url>:<server_port>/proxy/tag/<tag1>
